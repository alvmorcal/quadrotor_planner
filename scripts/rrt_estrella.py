...
class DroneNavigator:
    ...
    def move_to_waypoints(self, waypoints):
        ...
        for i, waypoint in enumerate(waypoints):
            ...
            # Ajustar el radio de proximidad según el waypoint
            if i == len(waypoints):  # Último waypoint
                proximity_radius = 0.1
            else:  # Waypoints intermedios
            ...
            while not rospy.is_shutdown():
                ...
                # Incrementar velocidad cercana al waypoint
                ...
                # Publicar la velocidad como objetivo
